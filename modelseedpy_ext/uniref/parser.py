    ...
    def parse_entry(self, elem, parser):
        ...
        for action, elem in parser:
            ...
            if action == 'start' and tag == self.tag_name:
                ...
                uniref_entry_representative_member = self.parse_member(elem, parser, self.tag_representative_member)
                uniref_entry['representative_members'].append(uniref_entry_representative_member)
