...
class ETLTransformUniprot(ETLTransformGraph):
    ...
    def __init__(self, seq_store_protein, uniprot_type="sprot"):
        ...
        self.uniprot_collection_has_accession = (
            f"uniprotkb_{uniprot_type}_has_accession"
        )
        self.uniprot_collection_has_protein_sequence = (
            f"uniprotkb_{uniprot_type}_has_protein_sequence"
        )
        self.uniprot_collection_has_reference_to_kegg_gene = (
            f"uniprotkb_{uniprot_type}_has_reference_to_kegg_gene"
        )
        self.uniprot_collection_has_reference_to_alphafolddb = (
            f"uniprotkb_{uniprot_type}_has_reference_to_alphafolddb"
        )
        self.uniprot_collection_has_cofactor_chebi = (
            f"uniprotkb_{uniprot_type}_has_cofactor_chebi_term"
        )
        self.uniprot_collection_has_reaction_rhea = (
            f"uniprotkb_{uniprot_type}_has_catalytic_activity_rhea_reaction"
        )
        self.uniprot_collection_has_reaction_ec = (
            f"uniprotkb_{uniprot_type}_has_catalytic_activity_ec_number"
        )
...
class ETLTransformUniprot2(ETLTransformGraph):
    ...
    def transform(self, entry):
        ...
        uniprot_collection_has_protein_sequence = (
            f"uniprotkb_{uniprot_type}_has_protein_sequence"
        )
